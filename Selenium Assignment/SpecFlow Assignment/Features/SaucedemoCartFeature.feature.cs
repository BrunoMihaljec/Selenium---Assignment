...
namespace SpecFlow_Assignment.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("SaucedemoCartFeature In order to test login functionality on saucedemo")]
    public partial class SaucedemoCartFeatureInOrderToTestLoginFunctionalityOnSaucedemoFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "SaucedemoCartFeature In order to test login functionality on saucedemo", "As a developer\r\nI want to ensure functionality is working end to end\t", ProgrammingLanguage.CSharp, ((string[])(null)));
